...
docker exec cli0.Org2 bash -c 'peer channel update -o orderer0.artxchg2.com:7050 -c org2 -f ./channels/org2anchor.tx'
docker exec cli.ArtMarket bash -c 'peer channel update -o orderer0.artxchg2.com:7050 -c org1 -f ./channels/marketanchororg1.tx'
