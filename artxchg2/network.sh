docker exec cli.ArtMarket bash -c 'peer channel create -c org1 -f ./channels/Org1.tx -o orderer.artxchg2.com:7050'
docker exec cli.ArtMarket bash -c 'peer channel create -c org2 -f ./channels/Org2.tx -o orderer.artxchg2.com:7050'
...
docker exec cli0.Org2 bash -c 'peer channel update -o orderer.artxchg2.com:7050 -c org2 -f ./channels/org2anchor.tx'
docker exec cli.ArtMarket bash -c 'peer channel update -o orderer.artxchg2.com:7050 -c org1 -f ./channels/marketanchororg1.tx'
docker exec cli.ArtMarket bash -c 'peer channel update -o orderer.artxchg2.com:7050 -c org2 -f ./channels/marketanchororg2.tx'
